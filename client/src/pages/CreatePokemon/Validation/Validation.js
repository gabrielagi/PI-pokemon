const validation = (pokemonData) => {
  ...
  if (pokemonData.hp < 1 || pokemonData.hp > 150) {
    errors.hp =
      "The life level of a pokemon must be greater than zero and less than 150";
  }
  ...
  if (pokemonData.attack < 1 || pokemonData.attack > 200) {
    errors.attack =
      "The attack level of a pokemon must be greater than zero and less than 200";
  }
  ...
  if (pokemonData.defense < 1 || pokemonData.defense > 200) {
    errors.defense =
      "The defense level of a pokemon must be greater than zero and less than 200";
  }
  // Validación por la velocidad: speed
  if (pokemonData.speed < 1 || pokemonData.speed > 100) {
    errors.speed =
      "The speed of a pokemon must be greater than zero and less than 100";
  }
  // Validación por la velocidad: height
  if (pokemonData.height < 1 || pokemonData.height > 80) {
    errors.height =
      "The height of a pokemon must be greater than zero and less than 80";
  }
  // Validación por la velocidad: weight
  if (pokemonData.weight < 1 || pokemonData.weight > 1200) {
    errors.weight =
      "The weight of a pokemon must be greater than zero and less than 1200";
  }
  // Validación por la velocidad: weight
